...
public class ProductoTipoDAO {
    ...
    public String insertar(ProductoTipo tipo) {
        ...
        try (Connection conn = Conexion.getConexion();
            ...
            // Manejo de duplicados (nombre único)
            if (e.getMessage().toLowerCase().contains("duplicate")) {
                return "Ya existe un tipo de producto con ese nombre.";
            }
            return "⚠️ Error de restricción de integridad.";
    ...
    public String actualizar(ProductoTipo tipo) {
        ...
        try (Connection conn = Conexion.getConexion();
            ...
            if (filas > 0) {
                ...
                return "No se encontró el tipo de producto a actualizar.";
            }
    ...
    public String eliminar(int id) {
        ...
        try (Connection conn = Conexion.getConexion();
            ...
            if (filas > 0) {
                ...
                return "No se encontró el tipo de producto a eliminar.";
            }

        } catch (SQLIntegrityConstraintViolationException e) {
            // Si está referenciado en la tabla inventario
